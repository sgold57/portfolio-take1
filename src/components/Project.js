      ...
      <section className="container flex flex-col content-center mb-8 sm:mb-24 mr-4">
        ...
        <section className="projSection grid cols-span-2 xl:grid-cols-2 gap-8 ml-12 mr-8 xl:mr-4 xl:ml-20 xl:pb-12">
          ...
          <article className="border-2 border-black border-solid projArticle relative rounded-lg shadow-xl bodyFont bg-yellow-100 py-8 px-10 shadow-xl">
            ...
            <div className="attributesDiv flex flex-col sm:block justify-evenly text-md space-x-0.5 sm:space-x-4">  {/* where all the information (title, type, date) will live */}
              <div className="flex sm:content-evenly lg:content-center py-1 sm:pl-28 md:pl-36 lg:pl-64 xl:pl-40 text-sm sm:text-lg lg:text-xl">
              ...
              <span className="fiSpan text-red-500 text-base lg:text-xl sm:pl-20 md:pl-44 lg:pl-64 xl:pl-40 py-2">
