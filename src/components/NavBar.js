...
export default function NavBar(){
  return (
    <header className="bgImageOffWhite bg-cover sticky top-0 w-screen h-12 sm:h-20 lg:h-24 z-10">
        <nav className="flex flex-row">
          <NavLink 
            ...
            className="nameTab bodyFont imageRed text-opacity-80 font-bold tracking-normal md:tracking-tighter sm:items-center text-2xl sm:text-3xl md:text-4xl lg:text-6xl mx-1 mt-4 lg:mt-4 xl:mt-6 md:ml-6 lg:ml-3 xl:ml-6 md:mr-4 pr-2 md:pr-0"
          >
            SAM GOLD
          </NavLink>
          <div className="tabsDiv flex ml-1"> 
            <NavLink 
              ...
              className="inactiveTab tabFont items-center text-blue-700 text-opacity-90 tracking-tight text-md md:text-2xl lg:text-4xl xl:text-5xl font-semibold tracking:wide mr-3 mt-3 sm:mx-2 sm:mt-5 md:px-1 lg:mt-7 xl:mt-8 xl:mb-4 lg:ml-2 xl:ml-5 hover:text-red-600"
            ...
            <NavLink 
              ...
              // className="inline-flex tabFont items-center text-blue-700 text-opacity-90 tracking-tight text-sm sm:text-lg md:text-xl lg:text-3xl xl:text-4xl font-semibold mx-2 md:px-1 mt-5 lg:mt-6 xl:mt-7 xl:mb-4 lg:px-2 xl:ml-10 hover:text-red-600"
              className="tabFont items-center text-blue-700 text-opacity-90 tracking-tight text-md md:text-2xl lg:text-4xl xl:text-5xl font-semibold tracking:wide mr-3 mt-3 sm:mx-2 sm:mt-5 md:px-1 lg:mt-7 xl:mt-8 xl:mb-4 lg:ml-2 xl:ml-5 hover:text-red-600"
              activeClassName="activeNav focus:text-red-600 bg-blue-700 text-opacity-90 px-1 bg-opacity-40 rounded-lg"
            >
              ABOUT
            </NavLink>
        ...
        <div className="hidden sm:inline-flex ml-2 mr-4 lg:ml-7 lg:mr-1">
          ...
          <SocialIcon 
            ...
            className="githubLogo mr-3 sm:mr-2 xl:mr-5 mt-5 lg:mt-7" 
            target="_blank" //opens new tab
            fgColor="#fff" 
            style={{ height: 45, width: 45 }}
            />
          <SocialIcon 
            ...
            className="mediumLogo mr-3 sm:mr-2 xl:mr-5 mt-5 lg:mt-7" 
            target="_blank" //opens new tab
            fgColor="#fff" 
            style={{ height: 45, width: 45 }}
            />
