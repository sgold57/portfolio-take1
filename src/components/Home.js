    ...
    <main className="relative bg-blue-700 min-h-screen w-screen mt-20 lg:mt-24 xl:mt-28">
      <section className="relative flex max-w-screen top-12 py-24 border-8 border-red-600">
        ...
        <div className="absolute flex-col content-evenly inset-y-0 left-1/2 w-1/2 homeLabelChildPadding border-8 border-solid border-red-400 text-lg lg:text-5xl">
          <div className="border-solid border-2 mt-2 lg:mt-16 py-8 px-6 border-gray-600 bodyFont font-extrabold ">
            <span className="text-yellow-200">SOFTWARE</span>
            <span className="text-red-500 m-2 lg:m-6">ENGINEER</span>
          </div>
          <div className="border-solid border-2 lg:mt-16 p-8 border-yellow-600 bodyFont font-extrabold text-yellow-200 text-lg lg:text-5xl">
            <span className="text-red-500">PROBLEM</span>
            <span className="text-yellow-200 m-4 lg:m-6">SOLVER</span>
          </div> 
          <div className="border-solid border-2 lg:mt-28 p-8 border-yellow-600 bodyFont font-extrabold text-yellow-200 text-lg lg:text-5xl">
          ...
          <div className="border-solid border-2 lg:mt-16 p-8 border-yellow-600 bodyFont font-extrabold text-yellow-200 lg:text-5xl">
